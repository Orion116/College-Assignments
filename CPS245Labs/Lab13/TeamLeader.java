...
public class TeamLeader extends ProductionWorker
{
	...
	public TeamLeader( double hourlyRate,
					   double hours,
					   int shift,
					   double trainingHours )
	{
		super( hourlyRate, hours, shift );  //Calls the super class
	...
	public static void main( String args[] )
	{
		...
		TeamLeader defaultTeamLeader = new TeamLeader();
		TeamLeader dayTeamLeader = new TeamLeader( "9300909903",
												   "Jane Doe",
												   8.00, 50, 1, 5 );
		/*** Night Workers ***/

		TeamLeader nightTeamLeader1 = new TeamLeader( 0, 40, 2, 3 );
